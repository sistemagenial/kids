...
export default function Home() {
  ...
  useEffect(() => {
    // Redirecionar automaticamente para login se acessar /kids
    if (window.location.pathname === '/kids' || window.location.pathname === '/kids/' || window.location.pathname === '/') {
      navigate('/login');
      return;
    }
  ...
  const handleDrawingsClick = () => {
    // Agora redireciona para a página de vídeos
    if (user) {
      navigate('/videos');
    } else {
      navigate('/login');
  ...
  return (
    ...
    >
      ...
      {/* Conteúdo principal */}
      <main className="container mx-auto px-4 py-8 md:py-16 relative z-10 flex-1 flex items-center justify-center">
        <div className="w-full max-w-4xl">
          ...
          <div className="text-center mb-12 md:mb-16">
            ...
            <h3 className="text-3xl md:text-5xl font-bold text-yellow-300 mb-6 md:mb-8 drop-shadow-lg" style={{ fontFamily: 'Pacifico, serif' }}>
              ✨
            </h3>
